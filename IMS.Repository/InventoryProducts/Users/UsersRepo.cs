...
namespace IMS.Repository
{
    public class UsersRepo
    {
        ...
        public List<Users> GetAll(string key)
        {
            ...
            {
                if (key == null)
                    sql = @"SELECT Id, Userld, FirstName, LastName, Password, Email, Age, Gender, Role, Salary, JoinDate, Birthdate,   NID, Phone,
                          HomeTown, CurrentCity, Division, BloodGroup, PostalCode
                          FROM Users";

                //else 
                //    sql = @"SELECT Id, Userld, FirstName, LastName, Password, Email, Age, Gender, Role, Salary, JoinDate, Birthdate,    NID, Phone, HomeTown, CurrentCity, Division, BloodGroup, PostalCode FROM Users 
                //          where UserId like '%"+key+"%' or Email like '%"+key+"%' or FirstName like '%"+key+"%' " +
